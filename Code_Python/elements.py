...
class base:
    ...
    def __init__(self, name=None, mass=0.0, inertia=np.eye(3), cc={}):
        ...
        cc          dict        Identifiers/positions of connected bodies
        """
        self.name = name
        self.mass = mass
...
class link:
    ...
    def __init__(self, name=None, mass=0.0, inertia=np.eye(3), cc={}, ce={},
                 Qe=np.zeros(3)):
        """
        name        str         Name
        mass        scalar      Mass [kg]
        ...
        ce          (3, )       Position of end-point [m]
        Qe          (3, )       Relative orientation of end-point [rad]
        """
        self.name = name
        self.mass = mass
        self.inertia = np.asarray(inertia)
    ...
    def info(self):
        ...
        print('Connections =')
        print(self.cc)
        print('End point position = ', self.ce)
        print('End point orientation = ', self.Qe)
        print('Rotation matrix =')
        print(self.AA)
        print('Position = ', self.RR)
        print('Velocity = ', self.vv)
